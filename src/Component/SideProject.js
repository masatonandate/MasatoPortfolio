...
const SideProject = ({Title, Description, Image, Date, Link, Key}) => {
  ...
  return(
    <>
      <div class="flex flex-col overflow-hidden rounded-lg border bg-white" key = {Key}>
        ...
        <div class="flex flex-1 flex-col p-4 sm:p-6">
          ...
          <div class="mt-auto flex items-end justify-between">
            ...
            <a href = {Link} target = "_blank" rel = "noopener noreferer" class="rounded border px-2 py-1 text-sm text-gray-500">Link to Repo</a>
          </div>
          :
          <div class="mt-auto flex items-end justify-between">
            <div class="flex items-center gap-2">
